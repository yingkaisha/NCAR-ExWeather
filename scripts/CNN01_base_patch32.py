'''
Train CNN that accepts 32-by-32 inputs
(Revamped)
'''
...
weights_round = 1
save_round = 2
model_prefix_load = 'RE2_32in_base{}'.format(weights_round) #False
model_prefix_save = 'RE2_32in_base{}'.format(save_round)
N_vars = L_vars = 15
# ==================== #
...
VALID_input_32 = np.empty((L_valid, 32, 32, L_vars))
...
for i, name in enumerate(filename_valid):
    ...
    for k, c in enumerate(ind_pick_from_batch):
        ...
        VALID_input_32[i, ..., k] = data[:, 16:-16, 16:-16, c]
...
tuple_save = (VALID_input_32, VALID_target)
label_save = ['VALID_input_32', 'VALID_target']
du.save_hdf5(tuple_save, label_save, save_dir, 'CNN_Validation_32.hdf')

# with h5py.File(save_dir+'CNN_Validation_32.hdf', 'r') as h5io:
#     VALID_input_32 = h5io['VALID_input_32'][...]
#     VALID_target = h5io['VALID_target'][...]

# model and weights
model_head = create_model_head(input_shape=(128,), N_node=64)
model_base = create_model(input_shape=(32, 32, 15), depths=[3, 3, 27, 3], projection_dims=[32, 32, 64, 64], first_pool=2)
