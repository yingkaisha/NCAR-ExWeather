'''
Train CNN to produce 64-sized feature vectors
(Revamped)
'''
...
save_round = 7
seeds = 777
model_prefix_load = 'RE2_vec64_base{}'.format(weights_round)
model_prefix_save = 'RE2_vec64_base{}'.format(save_round)
N_vars = L_vars = 15
# ==================== #
...
du.save_hdf5(tuple_save, label_save, save_dir, 'CNN_Validation_small.hdf')

# with h5py.File(save_dir+'CNN_Validation_small.hdf', 'r') as h5io:
...
model_base = mu.create_model(input_shape=(64, 64, 15), depths=[3, 3, 27, 3], projection_dims=[32, 32, 64, 64])
...
# Get all pos and neg training batches
