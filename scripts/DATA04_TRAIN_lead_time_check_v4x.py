...
filename_train_lead2 = sorted(glob("/glade/campaign/cisl/aiml/ksha/NCAR_batch_v4x/TRAIN*lead2.npy"))
filename_train_lead3 = sorted(glob("/glade/campaign/cisl/aiml/ksha/NCAR_batch_v4x/TRAIN*lead3.npy"))
filename_train_lead4 = sorted(glob("/glade/campaign/cisl/aiml/ksha/NCAR_batch_v4x/TRAIN*lead4.npy"))
filename_train_lead5 = sorted(glob("/glade/campaign/cisl/aiml/ksha/NCAR_batch_v4x/TRAIN*lead5.npy"))
filename_train_lead6 = sorted(glob("/glade/campaign/cisl/aiml/ksha/NCAR_batch_v4x/TRAIN*lead6.npy"))
...
np.save('/glade/work/ksha/NCAR/TRAIN_lead_inds_v4x_part{}.npy'.format(part), save_dict)
print('/glade/work/ksha/NCAR/TRAIN_lead_inds_v4x_part{}.npy'.format(part))
