...
# HRRRv3_lead_p0 = zarr.load(save_dir_scratch+'HRRR_{:02}_v3.zarr'.format(leads[0]))[:730, ...]
# HRRRv3_lead_p1 = zarr.load(save_dir_scratch+'HRRR_{:02}_v3.zarr'.format(leads[1]))[:730, ...]
# HRRRv3_lead_p2 = zarr.load(save_dir_scratch+'HRRR_{:02}_v3.zarr'.format(leads[2]))[:730, ...]
        ...
        if x_edge_left >= 0 and y_edge_bottom >= 0 and x_edge_right < shape_3km[0] and y_edge_top < shape_3km[1]:
            ...
            if land_mask_3km[x_edge_left, y_edge_bottom] and land_mask_3km[x_edge_left, y_edge_top]:
                if land_mask_3km[x_edge_right, y_edge_bottom] and land_mask_3km[x_edge_right, y_edge_top]:
                    ...
                    save_name = '/glade/work/ksha/NCAR/stats_v3_80km_ix{}_iy{}_lead{}{}{}.npy'.format(ix, iy, 
