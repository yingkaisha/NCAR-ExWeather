...
indx_train, indy_train, days_train, flags_train = name_to_ind(filename_train1_pick_v3)
indx_valid, indy_valid, days_valid, flags_valid = name_to_ind(filename_valid1_pick_v3)
...
ALL_VEC = np.empty((N_days_train+N_days_valid, 2,)+grid_shape+(128,))
ALL_VEC[...] = np.nan
...
lon_norm_v3, lat_norm_v3, elev_norm_v3, mon_norm_v3 = feature_extract(filename_train1_pick_v3, 
                                                                      lon_80km, lon_minmax, 
...
lon_norm_v3, lat_norm_v3, elev_norm_v3, mon_norm_v3 = feature_extract(filename_valid1_pick_v3, 
                                                                      lon_80km, lon_minmax, 
                                                                      lat_80km, lat_minmax, elev_80km, elev_max)
...
indx, indy, days, flags = name_to_ind(filename_valid1_pick)

lon_norm_v3, lat_norm_v3, elev_norm_v3, mon_norm_v3 = feature_extract(filename_valid1_pick, 
                                                                      lon_80km, lon_minmax, 
                                                                      lat_80km, lat_minmax, elev_80km, elev_max)
...
VALID_VEC = np.empty((N_days, 2,)+grid_shape+(128,))
VALID_VEC[...] = np.nan
