...
indx_train, indy_train, days_train, flags_train = name_to_ind(filename_train2_pick_v3)
indx_valid, indy_valid, days_valid, flags_valid = name_to_ind(filename_valid2_pick_v3)
...
ALL_VEC = np.empty((N_days_train+N_days_valid, 3,)+grid_shape+(128,))
ALL_VEC[...] = np.nan
